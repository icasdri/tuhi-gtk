...
from tuhi_gtk.config import log, BUFFER_ACTIVITY_CHECKERS_RESOLUTION, BUFFER_ACTIVITY_TARGET_COUNT, \
...
class SourceViewController(object):
    ...
    def set_intercontroller_dependency(self, list_controller):
        ...
        log.co.debug("Source View Controller - Intercontroller Dependencies Set")
        self.list_controller = list_controller

    def startup(self):
        log.co.info("Starting up Source View")
        pass
